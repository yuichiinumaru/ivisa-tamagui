...
```yaml
- generic [ref=e2]:
  - 'heading "Element type is invalid: expected a string (for built-in components) or a class/function (for composite components) but got: undefined. You likely forgot to export your component from the file it''s defined in, or you might have mixed up default and named imports." [level=1] [ref=e3]'
  ...
  - list [ref=e5]:
    ...
    - listitem [ref=e13]:
      ...
      - text: .
  - code [ref=e17]: "Check the render method of `MobileSidebar`."
```