...
import { IvisaCheckbox } from './Checkbox';
...
const CheckboxWithLabel = (args: any) => {
  ...
  return (
    <XStack alignItems="center" gap="$3">
      <IvisaCheckbox id="terms" checked={checked} onCheckedChange={setChecked} {...args} />
      <Label htmlFor="terms" color="$foreground">Accept terms and conditions</Label>
    </XStack>
  );
};

const meta: Meta<typeof IvisaCheckbox> = {
  title: 'Atoms/IvisaCheckbox',
  component: IvisaCheckbox,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
