  ...
  base: {
    ...
    extra: {
      ...
      ivisa_light: {
        ...
        ...lightShadows,
        shadowColor: lightShadows.shadow1,
        primary: ivisaColors.primary[600],
        primaryHover: ivisaColors.primary[700],
        primaryPress: ivisaColors.primary[800],
        primaryForeground: '#FFFFFF',
        secondary: ivisaColors.secondary[500],
        secondaryHover: ivisaColors.secondary[600],
        secondaryPress: ivisaColors.secondary[700],
        secondaryForeground: '#FFFFFF',
        muted: ivisaColors.gray[100],
        mutedForeground: ivisaColors.gray[500],
        accent: ivisaColors.secondary[100],
        accentForeground: ivisaColors.secondary[900],
        destructive: Colors.red.red10,
        destructiveHover: Colors.red.red11,
        destructivePress: Colors.red.red12,
        destructiveForeground: Colors.white,
        border: ivisaColors.gray[200],
        input: ivisaColors.gray[200],
        ring: ivisaColors.primary[600],
        background: '#FFFFFF',
        foreground: ivisaColors.gray[950],
      },
      ivisa_dark: {
        ...Colors.greenDark,
        ...Colors.redDark,
        ...
        ...darkShadows,
        shadowColor: darkShadows.shadow1,
        primary: ivisaColors.primary[500],
        primaryHover: ivisaColors.primary[400],
        primaryPress: ivisaColors.primary[300],
        primaryForeground: '#FFFFFF',
        secondary: ivisaColors.secondary[600],
        secondaryHover: ivisaColors.secondary[500],
        secondaryPress: ivisaColors.secondary[400],
        secondaryForeground: '#FFFFFF',
        muted: ivisaColors.darkBlueGray[900],
        mutedForeground: ivisaColors.darkBlueGray[300],
        accent: ivisaColors.darkBlueGray[900],
        accentForeground: ivisaColors.darkBlueGray[100],
        destructive: Colors.redDark.red10,
        destructiveHover: Colors.redDark.red11,
        destructivePress: Colors.redDark.red12,
        destructiveForeground: Colors.white,
        border: ivisaColors.darkBlueGray[700],
        input: ivisaColors.darkBlueGray[700],
        ring: ivisaColors.primary[500],
        background: ivisaColors.darkBlueGray[950],
        foreground: ivisaColors.gray[50],
      },
    },
  },
  accent: {
