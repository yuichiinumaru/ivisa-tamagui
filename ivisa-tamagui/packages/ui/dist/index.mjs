...
import React14, { useEffect, useLayoutEffect } from "react";
var IS_REACT_19 = typeof React14.use < "u";
var isWeb = true;
...
var withStaticProperties2 = (component, staticProps) => {
  const next = (() => {
    if (component[Decorated]) {
      const _ = React15.forwardRef((props, ref) => React15.createElement(component, {
        ...props,
        ref
      }));
...
var ProgressComponent = React19.forwardRef(
...
function withErrorLogging(componentName, Component3) {
  const Wrapped = React21.forwardRef((props, ref) => {
    try {
...
var TextareaImpl = React22.forwardRef(
  ({
    variant = "default",
    size = "default",
    invalid = false,
...
var CheckboxImpl = React24.forwardRef(
  ({
    checked: checkedProp,
    defaultChecked,
    onCheckedChange,
    ...
    const realId = id2 || React24.useId();
...
var CardHeader = styled24(YStack9, {
  name: "CardHeader",
  gap: "$1.5"
});
...
var CardContent = styled24(YStack9, {
  name: "CardContent",
  gap: "$4"
});
...
var CollapsibleRoot = styled25(CollapsiblePrimitive.Root, {
  name: "Collapsible",
  width: "100%"
});
...
var Collapsible = React25.forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsx26(CollapsibleContext.Provider, { value: { open }, children: /* @__PURE__ */ jsxs16(
      CollapsibleRoot,
      {
        ...props,
        ref,
        ...
        defaultOpen,
        children: [
          /* @__PURE__ */ jsx26(CollapsiblePrimitive.Trigger, { asChild: true, disabled: isDisabled2 || isLoading, children: /* @__PURE__ */ jsxs16(
            CollapsibleTrigger,
            {
              hasError,
          ...
          /* @__PURE__ */ jsx26(CollapsibleContent, { children: isLoading ? /* @__PURE__ */ jsxs16(YStack10, { space: "$2", "data-testid": "skeleton-container", children: [
            /* @__PURE__ */ jsx26(Skeleton, { height: 40 }),
            /* @__PURE__ */ jsx26(Skeleton, { height: 40 })
          ] }) : children })
        ]
      }
...
var DialogOverlay = styled26(TamaguiDialog.Overlay, {
  name: "DialogOverlay",
  backgroundColor: "rgba(0, 0, 0, 0.5)",
  animation: "quick",
  opacity: 1,
...
var DialogContent = styled26(TamaguiDialog.Content, {
  name: "DialogContent",
  backgroundColor: "$background",
  borderRadius: "$lg",
  padding: "$lg",
...
var DialogHeader = styled26(YStack11, {
  name: "DialogHeader",
  marginBottom: "$md",
  gap: "$sm"
});
var DialogTitle = styled26(TamaguiDialog.Title, {
  name: "DialogTitle",
  fontSize: "$6",
  fontWeight: "600",
  color: "$foreground",
...
var DialogDescription = styled26(TamaguiDialog.Description, {
...
var DialogContentComposite = React26.forwardRef(({ children, isLoading = false, hasError = false, ...props }, ref) => {
  return /* @__PURE__ */ jsxs17(DialogPortal, { children: [
    /* @__PURE__ */ jsx27(DialogOverlay, {}, "overlay"),
    /* @__PURE__ */ jsxs17(DialogContent, { ref, hasError, ...props, children: [
      isLoading ? /* @__PURE__ */ jsx27(Skeleton, { height: 250 }) : children,
      /* @__PURE__ */ jsx27(Unspaced, { children: /* @__PURE__ */ jsx27(TamaguiDialog.Close, { asChild: true, children: /* @__PURE__ */ jsx27(
        Button4,
        {
          "aria-label": "Fechar",
          position: "absolute",
...
var SheetComponent = ({ isLoading = false, hasError = false, children, ...props }) => /* @__PURE__ */ jsx28(SheetContext.Provider, { value: { isLoading, hasError }, children: /* @__PURE__ */ jsx28(TamaguiSheet, { ...props, children }) });
var SheetOverlay = styled27(TamaguiSheet.Overlay, {
  name: "SheetOverlay",
...
var SheetHandle = styled27(TamaguiSheet.Handle, {
  name: "SheetHandle",
  backgroundColor: "$borderColor",
  opacity: 0.8
});
var SheetContentFrame = styled27(TamaguiSheet.Frame, {
  name: "SheetContent",
  backgroundColor: "$background",
  padding: "$4",
...
var SheetContent = forwardRef6(
  ({ children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs18(TamaguiSheet.Portal, { children: [
      /* @__PURE__ */ jsx28(SheetOverlay, {}),
      /* @__PURE__ */ jsxs18(SheetContentFrame, { ref, ...props, hasError, children: [
        /* @__PURE__ */ jsx28(SheetHandle, {}),
        isLoading ? /* @__PURE__ */ jsxs18(YStack12, { gap: "$4", py: "$4", children: [
          /* @__PURE__ */ jsxs18(YStack12, { gap: "$2", marginBottom: "$4", children: [
            /* @__PURE__ */ jsx28(Skeleton, { height: 30, width: "60%" }),
            /* @__PURE__ */ jsx28(Skeleton, { height: 20, width: "90%" })
          ] }),
          /* @__PURE__ */ jsxs18(YStack12, { gap: "$4", py: "$4", children: [
            /* @__PURE__ */ jsxs18(YStack12, { gap: "$2", children: [
              /* @__PURE__ */ jsx28(Skeleton, { height: 16, width: "30%" }),
...
var SheetHeader = styled27(YStack12, {
  name: "SheetHeader",
  gap: "$2",
  marginBottom: "$4"
});
...
var SheetFooter = styled27(SheetFooterComponent, {
  name: "SheetFooter",
  justifyContent: "flex-end",
  gap: "$2",
  marginTop: "$4"
});
var SheetTitle = styled27(H22, {
  name: "SheetTitle",
  fontWeight: "bold",
  fontSize: "$6",
  color: "$foreground"
});
var SheetDescription = styled27(Paragraph3, {
  name: "SheetDescription",
  fontSize: "$3",
  color: "$mutedForeground"
});
var SheetCloseFrame = styled27(Button, {
  name: "SheetClose"
});
...
function DrawerComponent({
  ...
  return /* @__PURE__ */ jsxs19(Fragment5, { children: [
    ...
    /* @__PURE__ */ jsx29(Sheet, { open, onOpenChange: setOpen, children: /* @__PURE__ */ jsxs19(Sheet.Portal, { children: [
      ...
      /* @__PURE__ */ jsxs19(Sheet.Content, { animation: "medium", enterStyle: { y: 300 }, exitStyle: { y: 300 }, children: [
        /* @__PURE__ */ jsx29(Sheet.Handle, {}),
        /* @__PURE__ */ jsxs19(Sheet.Header, { children: [
          /* @__PURE__ */ jsx29(Sheet.Title, { color: hasError ? "$red10" : void 0, children: title }),
          description && /* @__PURE__ */ jsx29(Sheet.Description, { children: description })
        ] }),
        /* @__PURE__ */ jsx29(YStack13, { flex: 1, paddingVertical: "$4", children: isLoading ? /* @__PURE__ */ jsxs19(YStack13, { space: true, children: [
          /* @__PURE__ */ jsx29(Skeleton, { height: 40 }),
          /* @__PURE__ */ jsx29(Skeleton, { height: 20, width: "75%" })
        ] }) : children }),
        footer && /* @__PURE__ */ jsx29(Sheet.Footer, { children: footer })
      ] })
    ] }) })
  ] });
}
...
var DropdownMenuSubTriggerFrame = styled28(DropdownMenuPrimitive.SubTrigger, {
  flexDirection: "row",
  alignItems: "center",
  paddingVertical: "$2",
  paddingHorizontal: "$2",
...
var DropdownMenuSubTrigger = React29.forwardRef(({ className: _className, children, inset, ...props }, ref) => /* @__PURE__ */ jsxs20(
...
var DropdownMenuSubContentFrame = styled28(DropdownMenuPrimitive.SubContent, {
  minWidth: 180,
  // roughly 8rem
  backgroundColor: "$background",
  borderRadius: "$md",
...
var DropdownMenuContentFrame = styled28(DropdownMenuPrimitive.Content, {
  minWidth: 220,
  backgroundColor: "$background",
  borderRadius: "$md",
  borderWidth: 1,
...
var DropdownMenuItemFrame = styled28(DropdownMenuPrimitive.Item, {
  flexDirection: "row",
  alignItems: "center",
  paddingVertical: "$2",
  paddingHorizontal: "$2",
...
var DropdownMenuItem = React29.forwardRef(({ className: _className, inset, ...props }, ref) => /* @__PURE__ */ jsx30(
...
var DropdownMenuCheckboxItemFrame = styled28(DropdownMenuPrimitive.CheckboxItem, {
  flexDirection: "row",
  alignItems: "center",
  paddingVertical: "$2",
  paddingLeft: "$8",
...
var DropdownMenuCheckboxItem = React29.forwardRef(({ className: _className, children, checked, ...props }, ref) => /* @__PURE__ */ jsxs20(
...
var DropdownMenuRadioItemFrame = styled28(DropdownMenuPrimitive.RadioItem, {
  flexDirection: "row",
  alignItems: "center",
  paddingVertical: "$2",
  paddingLeft: "$8",
...
var DropdownMenuLabel = styled28(DropdownMenuPrimitive.Label, {
  paddingHorizontal: "$2",
  paddingVertical: "$1.5",
  fontSize: "$3",
  fontWeight: "600",
...
var DropdownMenuSeparator = styled28(DropdownMenuPrimitive.Separator, {
  height: 1,
  backgroundColor: "$muted",
  marginVertical: "$1"
});
...
var PopoverContentFrame = styled29(TamaguiPopover.Content, {
  name: "PopoverContent",
  backgroundColor: "$background",
  borderColor: "$borderColor",
  borderWidth: 1,
...
var PopoverArrow = styled29(TamaguiPopover.Arrow, {
  name: "PopoverArrow",
  borderWidth: 1,
  borderColor: "$borderColor",
  backgroundColor: "$background"
...
var PopoverContent = forwardRef8(
  ({ children, actions, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs21(PopoverContentFrame, { ref, ...props, hasError, children: [
      /* @__PURE__ */ jsx31(PopoverArrow, { size: "$3" }),
      /* @__PURE__ */ jsxs21(YStack14, { gap: "$3", children: [
        children,
        actions && /* @__PURE__ */ jsx31(YStack14, { children: actions })
      ] })
    ] });
  }
);
...
var Popover = ({
  ...
  return /* @__PURE__ */ jsx31(PopoverContext.Provider, { value: contextValue, children: /* @__PURE__ */ jsx31(TamaguiPopover, { ...props, children }) });
};
var PopoverTrigger = forwardRef8(
  (props, ref) => {
    const { isDisabled: isDisabled2, isLoading } = usePopoverContext();
    return /* @__PURE__ */ jsx31(TamaguiPopover.Trigger, { ref, ...props, disabled: isDisabled2 || isLoading });
  }
);
...
var HoverCard = ({ children, ...rest }) => {
  return /* @__PURE__ */ jsx32(Popover2, { placement: "top", hoverable: true, ...rest, children });
};
var HoverCardTrigger = Popover2.Trigger;
var HoverCardContent = Popover2.Content;
    ...
    return /* @__PURE__ */ jsxs22(YStack15, { ...containerProps, children: [
      /* @__PURE__ */ jsxs22(XStack13, { space: "$4", ai: "center", children: [
        ...
        /* @__PURE__ */ jsxs22(YStack15, { space: "$1", children: [
          ...
          /* @__PURE__ */ jsx32(Skeleton, { h: "$2", w: "$8" })
        ] })
      ] }),
  ...
  return /* @__PURE__ */ jsxs22(YStack15, { ...containerProps, children: [
    /* @__PURE__ */ jsxs22(XStack13, { space: "$4", ai: "center", children: [
      ...
      /* @__PURE__ */ jsxs22(YStack15, { space: "$1", f: 1, children: [
        ...
        /* @__PURE__ */ jsx32(Paragraph4, { size: "$2", color: "$gray11", ellipse: true, children: user.handle })
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsxs22(XStack13, { space: "$4", children: [
      ...
      /* @__PURE__ */ jsxs22(Paragraph4, { size: "$2", children: [
        /* @__PURE__ */ jsx32(Paragraph4, { fontWeight: "bold", children: user.followers }),
        " Seguidores"
      ] })
    ] }),
    actions && /* @__PURE__ */ jsx32(XStack13, { jc: "flex-end", children: actions })
...
var RadioGroupItemFrame = styled30(TamaguiRadioGroup.Item, {
  name: "RadioGroupItem",
  width: 16,
  height: 16,
  borderRadius: "$10",
...
var RadioGroupIndicator = styled30(TamaguiRadioGroup.Indicator, {
...
var RadioGroupItem = React30.forwardRef((props, ref) => {
  return /* @__PURE__ */ jsx33(RadioGroupItemFrame, { ref, ...props, children: /* @__PURE__ */ jsx33(RadioGroupIndicator, { disabled: props.disabled }) });
});
RadioGroupItem.displayName = "RadioGroupItem";
var RadioGroup2 = React30.forwardRef(
  ({
    options,
...
var ResizablePanelGroup = React31.forwardRef(({
  direction = "horizontal",
  children,
  ...
  return /* @__PURE__ */ jsx34(ResizablePanelGroupContext.Provider, { value: contextValue, children: hasError ? /* @__PURE__ */ jsx34(Theme, { name: "red", children: content }) : content });
});
ResizablePanelGroup.displayName = "ResizablePanelGroup";
var ResizablePanelFrame = styled31(YStack17, {
  name: "ResizablePanel"
});
var ResizablePanel = React31.forwardRef(({ children, size, ...props }, ref) => {
  return /* @__PURE__ */ jsx34(ResizablePanelFrame, { ref, flexBasis: `${size}%`, ...props, children });
});
ResizablePanel.displayName = "ResizablePanel";
var ResizableHandleFrame = styled31(YStack17, {
...
var ResizableHandleIndicator = styled31(Separator3, {
  variants: {
    direction: {
      vertical: {
        width: "100%",
...
var ResizableHandle = React31.forwardRef(({ withHandle, handleIndex, ...props }, ref) => {
  const {
    direction,
    startDragging,
    adjustPanelSize,
  ...
  return /* @__PURE__ */ jsxs24(
    ResizableHandleFrame,
    {
      ...
      children: [
        /* @__PURE__ */ jsx34(ResizableHandleIndicator, { direction }),
        withHandle && /* @__PURE__ */ jsx34(
          YStack17,
          {
            position: "absolute",
            padding: "$1.5",
            ...
            borderWidth: 1,
            borderColor: "$borderColor",
            children: /* @__PURE__ */ jsx34(GripVertical, { size: 16, color: "$color", "aria-label": "Arrastar para redimensionar" })
          }
        )
      ]
    }
...
var SelectContent = (props) => /* @__PURE__ */ jsxs25(TamaguiSelect.Content, { zIndex: 2e5, ...props, children: [
  /* @__PURE__ */ jsx35(
    TamaguiSelect.ScrollUpButton,
    {
      ...
      width: "100%",
      height: "$3",
      children: /* @__PURE__ */ jsx35(YStack18, { zIndex: 10, children: /* @__PURE__ */ jsx35(ChevronDown3, { size: 12 }) })
    }
  ),
  /* @__PURE__ */ jsx35(TamaguiSelect.Viewport, { minWidth: 200, children: props.children }),
  /* @__PURE__ */ jsx35(
...
var SelectItem = styled32(TamaguiSelect.Item, {
  name: "SelectItem",
  paddingHorizontal: "$3",
  paddingVertical: "$2",
  flexDirection: "row",
...
var SelectItemIndicator = (props) => /* @__PURE__ */ jsx35(TamaguiSelect.ItemIndicator, { marginLeft: "auto", ...props, children: /* @__PURE__ */ jsx35(Check3, { size: 16 }) });
var SelectSheet = (props) => /* @__PURE__ */ jsx35(Adapt, { when: "sm", platform: "touch", children: /* @__PURE__ */ jsxs25(
  Sheet2,
  {
    native: !isWeb2,
    modal: true,
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx35(Sheet2.Frame, { children: /* @__PURE__ */ jsx35(Sheet2.ScrollView, { children: /* @__PURE__ */ jsx35(Adapt.Contents, {}) }) }),
      /* @__PURE__ */ jsx35(Sheet2.Overlay, { animation: "lazy", enterStyle: { opacity: 0 }, exitStyle: { opacity: 0 } })
    ]
  }
) });
...
var StarRatingComponent = forwardRef9(
  ({
    ...
    if (isLoading) {
      return /* @__PURE__ */ jsx36(StarRatingFrame, { ...frameProps, ref, children: Array.from({ length: count }, (_, i) => /* @__PURE__ */ jsx36(Skeleton, { width: size, height: size, br: "$10" }, i)) });
    }
    return /* @__PURE__ */ jsxs26(StarRatingFrame, { ...frameProps, ref, children: [
...
var ToastViewportFrame = styled34(YStack19, {
  name: "ToastViewport",
  position: "absolute",
  bottom: "$4",
  right: "$4",
...
var ToastCloseButton = styled34(Button5, {
  size: "$2",
  circular: true,
  chromeless: true,
  position: "absolute",
...
var ToastProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ jsxs27(ToastContext.Provider, { value: { toasts, toast, dismiss }, children: [
    children,
    /* @__PURE__ */ jsx37(Portal2, { children: /* @__PURE__ */ jsx37(ToastViewportFrame, { role: "status", "aria-live": "polite", children: /* @__PURE__ */ jsx37(AnimatePresence, { children: toasts.map((t) => /* @__PURE__ */ jsx37(ToastItem, { toast: t, onDismiss: () => dismiss(t.id) }, t.id)) }) }) })
  ] });
};
var ToastItem = ({ toast, onDismiss }) => {
  if (toast.isLoading) {
    return /* @__PURE__ */ jsx37(
      ToastFrame,
      {
        ...
        scale: 1,
        y: 0,
        children: /* @__PURE__ */ jsxs27(YStack19, { flex: 1, gap: "$2", children: [
          /* @__PURE__ */ jsx37(Skeleton, { width: 150, height: 20 }),
          /* @__PURE__ */ jsx37(Skeleton, { width: 250, height: 15 })
        ] })
      }
    );
  }
  return /* @__PURE__ */ jsxs27(
    ToastFrame,
    {
      ...
      y: 0,
      children: [
        /* @__PURE__ */ jsxs27(YStack19, { flex: 1, gap: "$1", children: [
          toast.title && /* @__PURE__ */ jsx37(ToastTitleComponent, { variant: toast.variant, children: toast.title }),
          toast.description && /* @__PURE__ */ jsx37(ToastDescriptionComponent, { variant: toast.variant, children: toast.description })
        ] }),
        toast.action,
        /* @__PURE__ */ jsx37(ToastCloseButton, { onPress: onDismiss, "aria-label": "Fechar", children: /* @__PURE__ */ jsx37(X3, { size: "$1" }) })
      ]
    }
  );
};
...
var TabsFrame = styled35(TamaguiTabs, {
  name: "Tabs",
  flexDirection: "column",
  gap: "$2"
});
var InnerTabsList = styled35(TamaguiTabs.List, {
  name: "TabsList",
  flexDirection: "row",
  gap: "$1",
  flexShrink: 1,
...
var StyledTabsTrigger = styled35(TamaguiTabs.Tab, {
  name: "TabsTrigger",
  backgroundColor: "transparent",
  borderRadius: "$3",
  paddingVertical: "$1.5",
...
var StyledTabsContent = styled35(TamaguiTabs.Content, {
  name: "TabsContent",
  backgroundColor: "$background",
  padding: "$4",
  borderRadius: "$4",
...
var Tabs = ({
  ...
  return /* @__PURE__ */ jsx38(TabsContext.Provider, { value: { isLoading, hasError, isDisabled: isDisabled2 }, children: /* @__PURE__ */ jsx38(TabsFrame, { ...props, children: content }) });
};
var TabsList = ({
  actions,
  children,
  ...
  return /* @__PURE__ */ jsxs28(
    XStack19,
    {
      ...
      children: [
        /* @__PURE__ */ jsx38(InnerTabsList, { ...props, children }),
        actions && /* @__PURE__ */ jsx38(YStack20, { ml: "auto", children: actions })
      ]
    }
  );
};
var TabsTrigger = (props) => {
  ...
  return /* @__PURE__ */ jsx38(StyledTabsTrigger, { disabled: isDisabled2, ...props });
};
var TabsContent = (props) => {
  const { isLoading } = useTabsContext();
  return isLoading ? /* @__PURE__ */ jsxs28(YStack20, { space: true, children: [
    /* @__PURE__ */ jsx38(Skeleton, { height: 40 }),
    /* @__PURE__ */ jsx38(Skeleton, { height: 20 }),
    /* @__PURE__ */ jsx38(Skeleton, { height: 20 })
  ] }) : /* @__PURE__ */ jsx38(StyledTabsContent, { ...props });
};
...
var CalendarContainer = styled36(YStack21, {
  name: "Calendar",
  padding: "$4",
  borderRadius: "$6",
  borderWidth: 1,
...
var DayButtonFrame = styled36(Button, {
  width: 40,
  height: 40,
  padding: 0,
  justifyContent: "center",
...
var Calendar = ({
  ...
  return /* @__PURE__ */ jsxs29(CalendarContainer, { disabled: isDisabled2, hasError, "data-testid": "calendar-container", children: [
    /* @__PURE__ */ jsxs29(CalendarHeader, { children: [
      ...
      /* @__PURE__ */ jsx39(CalendarTitle, { children: isLoading ? /* @__PURE__ */ jsx39(Skeleton, { width: 120, height: 24 }) : currentMonth ? `${currentMonth.month} ${currentMonth.year}` : "" }),
      /* @__PURE__ */ jsx39(Button, { icon: ChevronRight2, circular: true, variant: "ghost", onPress: onNextClick, disabled: isLoading })
    ] }),
      ...
      /* @__PURE__ */ jsx39(DaysGrid, { children: currentMonth.days.map((day, index) => {
        ...
        return /* @__PURE__ */ jsx39(
          DayButtonFrame,
          {
            ...
            onPress: onDayClick,
            ...dayProps,
            children: /* @__PURE__ */ jsx39(DayText, { selected: day.selected, children: day.day })
          },
          index
        );
      }) })
...
var DatePicker = React37.forwardRef(
  ({
    date,
    onDateChange,
    variant = "default",
    ...
    if (loading) {
      return /* @__PURE__ */ jsx40(Skeleton, { height: 40, borderRadius: "$md" });
    }
    const trigger = /* @__PURE__ */ jsxs30(DatePickerFrame, { variant, state, disabled, children: [
      /* @__PURE__ */ jsx40(
        Input.Box,
        {
          flex: 1,
    ...
    return /* @__PURE__ */ jsxs30(Popover3, { open, onOpenChange: setOpen, ...props, children: [
      trigger,
      /* @__PURE__ */ jsx40(Adapt2, { when: "sm", platform: "touch", children: /* @__PURE__ */ jsxs30(Sheet3, { modal: true, dismissOnSnapToBottom: true, children: [
        /* @__PURE__ */ jsx40(Sheet3.Frame, { padding: "$4", children: /* @__PURE__ */ jsx40(Adapt2.Contents, {}) }),
        /* @__PURE__ */ jsx40(Sheet3.Overlay, {})
      ] }) }),
      /* @__PURE__ */ jsx40(PopoverContent, { p: 0, children: /* @__PURE__ */ jsx40(Calendar, { selectedDate: date, onDateChange: handleDateSelect }) })
    ] });
  }
);
...
import { Input as TamaguiInput2, YStack as YStack23, isWeb as isWeb3, styled as styled38 } from "tamagui";
import { jsx as jsx41 } from "react/jsx-runtime";
var OTPInputFrame = styled38(YStack23, {
  name: "OTPInputFrame",
  flexDirection: "row",
  gap: "$sm",
  alignItems: "center"
});
var OTPCellInput = styled38(TamaguiInput2, {
  name: "OTPInputCell",
  width: 48,
  height: "$2xl",
  textAlign: "center",
...
var OTPInputImpl = React38.forwardRef(
  ({
    length: lengthProp = 6,
    value: valueProp,
    ...
    const setValue = React38.useCallback(
      (next) => {
    ...
    const notifyCompletion = React38.useCallback(
      (chars) => {
    ...
    const setCharacterAtIndex = React38.useCallback(
      (index, char) => {
    ...
    const handlePaste = React38.useCallback(
      (index, event3) => {
        if (!isWeb3) return;
        event3.preventDefault?.();
    ...
    if (isLoading) {
      return /* @__PURE__ */ jsx41(OTPInputFrame, { ref, ...frameProps, children: Array.from({ length }, (_, index) => /* @__PURE__ */ jsx41(Skeleton, { width: 48, height: 48 }, `otp-skeleton-${index}`)) });
    }
    return /* @__PURE__ */ jsx41(OTPInputFrame, { ref, ...frameProps, children: valueArray.map((char, index) => /* @__PURE__ */ jsx41(
      OTPCellInput,
      {
        ref: (node) => {
...
var PaginationButton = styled39(Button6, {
      ...
      children: [
        ...
        showEdges && /* @__PURE__ */ jsxs31(
          PaginationButton,
          {
            ...
            children: [
              /* @__PURE__ */ jsx42(VisuallyHidden, { children: "Primeira p\xE1gina" }),
              /* @__PURE__ */ jsx42(ChevronsLeft, {})
            ]
          }
        ),
        /* @__PURE__ */ jsxs31(
          PaginationButton,
          {
            ...
            children: [
              /* @__PURE__ */ jsx42(VisuallyHidden, { children: "P\xE1gina anterior" }),
              /* @__PURE__ */ jsx42(ChevronLeft2, {})
            ]
          }
        ),
        ...
        /* @__PURE__ */ jsxs31(
          PaginationButton,
          {
            ...
            onPress: () => handleChange(currentPage + 1),
            children: [
              /* @__PURE__ */ jsx42(VisuallyHidden, { children: "Pr\xF3xima p\xE1gina" }),
              /* @__PURE__ */ jsx42(ChevronRight3, {})
            ]
          }
        ),
        showEdges && /* @__PURE__ */ jsxs31(
          PaginationButton,
          {
            ...
            children: [
              /* @__PURE__ */ jsx42(VisuallyHidden, { children: "\xDAltima p\xE1gina" }),
              /* @__PURE__ */ jsx42(ChevronsRight, {})
            ]
          }
        ),
        rightSlot
...
var BreadcrumbLink = styled40(Anchor, {
  name: "BreadcrumbLink",
  color: "$foreground",
  fontWeight: "500",
  hoverStyle: {
...
var BreadcrumbButton = styled40(Button7, {
...
var Breadcrumb = ({
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsx43(BreadcrumbRoot, { "data-testid": "breadcrumb-skeleton", children: /* @__PURE__ */ jsxs32(BreadcrumbList, { children: [
      /* @__PURE__ */ jsx43(Skeleton, { height: 20, width: 80 }),
      /* @__PURE__ */ jsx43(Skeleton, { height: 20, width: 100 }),
      /* @__PURE__ */ jsx43(Skeleton, { height: 20, width: 120 })
    ] }) });
  }
  if (!items || items.length === 0) {
    return null;
  }
  return /* @__PURE__ */ jsxs32(BreadcrumbRoot, { role: "navigation", "aria-label": ariaLabel, children: [
    /* @__PURE__ */ jsx43(BreadcrumbList, { role: "list", children: items.map((item, index) => {
      const isLast = index === items.length - 1;
      const linkRel = item.rel ?? (item.target === "_blank" ? "noreferrer noopener" : void 0);
      return /* @__PURE__ */ jsxs32(BreadcrumbItemWrapper, { role: "listitem", children: [
        isLast ? /* @__PURE__ */ jsx43(BreadcrumbCurrent, { "aria-current": "page", children: item.label }) : item.href ? /* @__PURE__ */ jsx43(
          BreadcrumbLink,
          {
            href: item.href,
            target: item.target,
        ...
        ) : /* @__PURE__ */ jsx43(BreadcrumbButton, { onPress: item.onPress, children: /* @__PURE__ */ jsx43(BreadcrumbButtonLabel, { children: item.label }) }),
...
import { AlertTriangle as AlertTriangle5, PieChart as PieChart2 } from "@tamagui/lucide-icons";
...
var SunburstChart = ({
  ...
  const renderContent = () => {
    ...
    if (!data) {
      return /* @__PURE__ */ jsxs55(YStack48, { flex: 1, justifyContent: "center", alignItems: "center", gap: "$2", height, children: [
        /* @__PURE__ */ jsx69(PieChart2, { color: "$gray10" }),
        /* @__PURE__ */ jsx69(Text34, { children: "N\xE3o h\xE1 dados para exibir." })
      ] });
    }
    return /* @__PURE__ */ jsx69(Svg, { width, height, children: /* @__PURE__ */ jsx69(G, { children: arcs.map((arc, i) => /* @__PURE__ */ jsx69(
      Path,
      {
        d: arc.path,
        fill: arc.color,
  ...
  return /* @__PURE__ */ jsxs55(YStack48, { width: "100%", gap: "$4", paddingHorizontal: "$4", alignItems: "center", children: [
    headerContent,
    renderContent()
  ] });
};
...
import { VictoryChart as VictoryChart6, VictoryLine as VictoryLine2, VictoryAxis as VictoryAxis6, VictoryGroup as VictoryGroup2 } from "victory";
import { AlertTriangle as AlertTriangle6, Activity } from "@tamagui/lucide-icons";
...
var ParallelCoordinates = ({
  ...
  const renderContent = () => {
    ...
    if (!data || data.length === 0) {
      return /* @__PURE__ */ jsxs56(YStack49, { flex: 1, justifyContent: "center", alignItems: "center", gap: "$2", height, children: [
        /* @__PURE__ */ jsx70(Activity, { color: "$gray10" }),
    ...
    return /* @__PURE__ */ jsxs56(
      VictoryChart6,
      {
        ...
        width,
        children: [
          attributes.map((attr, i) => /* @__PURE__ */ jsx70(
            VictoryAxis6,
            {
              dependentAxis: true,
              label: attr,
          ...
          /* @__PURE__ */ jsx70(VictoryGroup2, { children: normalizedData.map((series, i) => /* @__PURE__ */ jsx70(
            VictoryLine2,
            {
              data: series,
              style: {
...
import { VictoryChart as VictoryChart7, VictoryBar as VictoryBar2, VictoryAxis as VictoryAxis7, VictoryContainer as VictoryContainer3 } from "victory";
import { AlertTriangle as AlertTriangle7, BarChart2 } from "@tamagui/lucide-icons";
...
var MarimekkoChart = ({
  ...
  const renderContent = () => {
    ...
    if (!data || data.length === 0) {
      return /* @__PURE__ */ jsxs57(YStack50, { flex: 1, justifyContent: "center", alignItems: "center", gap: "$2", height, children: [
        /* @__PURE__ */ jsx71(BarChart2, { color: "$gray10" }),
...
import { VictoryChart as VictoryChart8, VictoryArea as VictoryArea2, VictoryAxis as VictoryAxis8 } from "victory";
import { AlertTriangle as AlertTriangle8, Activity as Activity2 } from "@tamagui/lucide-icons";
...
var RidgelinePlot = ({
  ...
  const axisColor = theme.borderColor?.get() || "#ccc";
  const textColor = theme.color?.get() || "#000";
  const processedSeries = useMemo11(() => {
  ...
  const renderContent = () => {
    ...
    if (!series || series.length === 0) {
      return /* @__PURE__ */ jsxs58(YStack51, { flex: 1, justifyContent: "center", alignItems: "center", gap: "$2", height, children: [
        /* @__PURE__ */ jsx72(Activity2, { color: "$gray10" }),
    ...
    return /* @__PURE__ */ jsxs58(
      VictoryChart8,
      {
        ...
        children: [
          ...
          processedSeries.map((s, i) => /* @__PURE__ */ jsx72(
            VictoryArea2,
            {
...
import { AlertTriangle as AlertTriangle9, GitMerge } from "@tamagui/lucide-icons";
...
var DecompositionTree = ({
  ...
  const renderContent = () => {
    ...
    if (!data) {
      return /* @__PURE__ */ jsxs59(YStack52, { flex: 1, justifyContent: "center", alignItems: "center", gap: "$2", height, children: [
        /* @__PURE__ */ jsx73(GitMerge, { color: "$gray10" }),
        /* @__PURE__ */ jsx73(Text38, { children: "N\xE3o h\xE1 dados para exibir." })
      ] });
    }
    return /* @__PURE__ */ jsx73(Svg2, { width, height, viewBox: `0 0 ${width} ${height}`, children: /* @__PURE__ */ jsxs59(G2, { children: [
      links.map((link, i) => {
      ...
      nodes.map((node, i) => /* @__PURE__ */ jsxs59(G2, { x: node.x, y: node.y, children: [
        /* @__PURE__ */ jsx73(
          Rect,
          {
            width: node.width,
  ...
  return /* @__PURE__ */ jsxs59(YStack52, { width: "100%", gap: "$4", paddingHorizontal: "$4", overflow: "scroll", children: [
    headerContent,
    renderContent()
  ] });
};
...
import { AlertTriangle as AlertTriangle10, Map as Map2 } from "@tamagui/lucide-icons";
...
var Maps = ({
  ...
  const renderContent = () => {
    ...
    if (!data) {
      return /* @__PURE__ */ jsxs60(YStack53, { flex: 1, justifyContent: "center", alignItems: "center", gap: "$2", height, children: [
        /* @__PURE__ */ jsx74(Map2, { color: "$gray10" }),
        /* @__PURE__ */ jsx74(Text39, { children: "N\xE3o h\xE1 dados para exibir." })
      ] });
    }
    return /* @__PURE__ */ jsx74(Svg3, { width, height, viewBox: `0 0 ${width} ${height}`, children: /* @__PURE__ */ jsxs60(G3, { children: [
      paths.map((p, i) => /* @__PURE__ */ jsx74(
        Path3,
        {
          d: p.d,
          fill: p.fill,
      ...
      circles.map((c, i) => /* @__PURE__ */ jsx74(
        Circle4,
        {
          cx: c.cx,
          cy: c.cy,
...
import { YStack as YStack54, XStack as XStack37, styled as styled61, View as View8, Text as Text40 } from "tamagui";
import { jsx as jsx75, jsxs as jsxs61 } from "react/jsx-runtime";
var TimelineFrame = styled61(YStack54, {
  name: "Timeline",
  tag: "ul",
  width: "100%",
  gap: "$4"
...
var TimelineContent = styled61(YStack54, {
  flex: 1,
  gap: "$1"
});
var TimelineTime = styled61(Text40, {
  fontSize: "$2",
  color: "$mutedForeground"
});
var TimelineTitle = styled61(Text40, {
  fontSize: "$3",
  fontWeight: "bold",
  color: "$foreground"
});
var TimelineDescription = styled61(Text40, {
  fontSize: "$3",
  color: "$foreground"
});
var TimelineItem = ({ title, description, time, isLast, children }) => {
  return /* @__PURE__ */ jsxs61(TimelineItemFrame, { children: [
    /* @__PURE__ */ jsxs61(View8, { children: [
      /* @__PURE__ */ jsx75(TimelineDot, {}),
      !isLast && /* @__PURE__ */ jsx75(TimelineConnector, {})
    ] }),
    /* @__PURE__ */ jsxs61(TimelineContent, { children: [
      time && /* @__PURE__ */ jsx75(TimelineTime, { children: time }),
      title && /* @__PURE__ */ jsx75(TimelineTitle, { children: title }),
      description && /* @__PURE__ */ jsx75(TimelineDescription, { children: description }),
      children
    ] })
  ] });
};
var TimelineSkeleton = () => /* @__PURE__ */ jsx75(TimelineFrame, { "data-testid": "timeline-skeleton", children: [...Array(3)].map((_, index) => /* @__PURE__ */ jsxs61(TimelineItemFrame, { children: [
  /* @__PURE__ */ jsx75(View8, { children: /* @__PURE__ */ jsx75(Skeleton, { width: 20, height: 20, borderRadius: 10 }) }),
  /* @__PURE__ */ jsxs61(TimelineContent, { children: [
    /* @__PURE__ */ jsx75(Skeleton, { width: "50%", height: 15 }),
    /* @__PURE__ */ jsx75(Skeleton, { width: "80%", height: 15 })
  ] })
] }, index)) });
var Timeline = ({ items, children, isLoading, isEmpty, hasError }) => {
  if (isLoading) {
    return /* @__PURE__ */ jsx75(TimelineSkeleton, {});
  }
  if (hasError) {
    return /* @__PURE__ */ jsxs61(Alert, { variant: "destructive", children: [
      /* @__PURE__ */ jsx75(Alert.Title, { children: "Erro" }),
      /* @__PURE__ */ jsx75(Alert.Description, { children: "Ocorreu um erro ao carregar os dados. Por favor, tente novamente." })
    ] });
  }
  if (isEmpty || items && items.length === 0 && !children) {
    return /* @__PURE__ */ jsx75(Empty, { title: "Nenhum item encontrado", description: "N\xE3o h\xE1 itens para serem exibidos no momento." });
  }
  if (items) {
    return /* @__PURE__ */ jsx75(TimelineFrame, { children: items.map((item, index) => /* @__PURE__ */ jsx75(TimelineItem, { ...item, isLast: index === items.length - 1 }, index)) });
  }
  return /* @__PURE__ */ jsx75(TimelineFrame, { children });
};

// src/organisms/FileUpload/FileUpload.tsx
import { useRef as useRef4 } from "react";
import { YStack as YStack55, styled as styled62, Text as Text41 } from "tamagui";
import { Upload } from "@tamagui/lucide-icons";
import { jsx as jsx76, jsxs as jsxs62 } from "react/jsx-runtime";
var FileUploadFrame = styled62(YStack55, {
  name: "FileUpload",
  borderWidth: 2,
  borderColor: "$borderColor",
  borderStyle: "dashed",
...
var FileUpload = ({
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxs62(FileUploadFrame, { ...props, children: [
      /* @__PURE__ */ jsx76(Skeleton, { height: 32, width: 32, borderRadius: "$12" }),
      /* @__PURE__ */ jsxs62(YStack55, { gap: "$1", alignItems: "center", width: "100%", children: [
        /* @__PURE__ */ jsx76(Skeleton, { height: 20, width: "60%" }),
        /* @__PURE__ */ jsx76(Skeleton, { height: 16, width: "80%" })
      ] })
    ] });
  }
  return /* @__PURE__ */ jsxs62(FileUploadFrame, { hasError, ...props, children: [
    /* @__PURE__ */ jsxs62(
      Button,
      {
        variant: "ghost",
        ...
        "aria-label": title,
        children: [
          /* @__PURE__ */ jsx76(Upload, { size: 32, color: hasError ? "$red10" : "$gray10" }),
          /* @__PURE__ */ jsxs62(YStack55, { gap: "$1", alignItems: "center", children: [
            /* @__PURE__ */ jsx76(Text41, { fontWeight: "bold", color: hasError ? "$red11" : void 0, children: title }),
            /* @__PURE__ */ jsx76(Text41, { fontSize: "$2", color: hasError ? "$red10" : "$gray11", children: subtitle })
          ] })
        ]
      }
    ),
    hasError && errorMessage && /* @__PURE__ */ jsx76(Text41, { fontSize: "$2", color: "$red11", textAlign: "center", children: errorMessage }),
    typeof document !== "undefined" && /* @__PURE__ */ jsx76(
      "input",
      {
        type: "file",
        ref: inputRef,
...
import { YStack as YStack56 } from "tamagui";
...
var renderFieldInput = (field, formField) => {
  ...
  switch (field.type) {
    ...
    case "textarea":
      return /* @__PURE__ */ jsx77(Textarea, { ...formField, ...commonProps, placeholder: field.placeholder });
    case "switch":
      return /* @__PURE__ */ jsx77(
        Switch,
        {
    ...
    case "select":
      return /* @__PURE__ */ jsxs63(
        SelectRoot,
        {
          ...
          disabled: field.disabled,
          children: [
            /* @__PURE__ */ jsx77(SelectRoot.Trigger, { placeholder: field.placeholder, children: /* @__PURE__ */ jsx77(SelectRoot.Value, { placeholder: field.placeholder }) }),
            /* @__PURE__ */ jsx77(SelectRoot.Sheet, {}),
            /* @__PURE__ */ jsx77(SelectRoot.Content, { children: /* @__PURE__ */ jsx77(SelectRoot.Viewport, { children: /* @__PURE__ */ jsx77(SelectRoot.Group, { children: field.options?.map((opt, i) => /* @__PURE__ */ jsxs63(SelectRoot.Item, { index: i, value: opt.value, children: [
              /* @__PURE__ */ jsx77(SelectRoot.ItemText, { children: opt.label }),
              /* @__PURE__ */ jsx77(SelectRoot.ItemIndicator, { marginLeft: "auto" })
            ] }, opt.value)) }) }) })
          ]
        }
      );
...
function SchemaForm({
  ...
  return /* @__PURE__ */ jsx77(Form, { ...form, children: /* @__PURE__ */ jsx77(FormRoot, { tag: "form", onSubmit: form.handleSubmit(onSubmit), children: /* @__PURE__ */ jsxs63(YStack56, { gap: "$4", children: [
    schema.map((field) => /* @__PURE__ */ jsx77(
      FormField,
      {
        control: form.control,
        name: field.name,
        rules: { required: field.required ? "Campo obrigat\xF3rio" : false },
        render: ({ field: formField }) => /* @__PURE__ */ jsxs63(FormItem, { children: [
          /* @__PURE__ */ jsx77(FormLabel, { children: field.label }),
          /* @__PURE__ */ jsx77(FormControl, { children: renderFieldInput(field, formField) }),
          field.description && /* @__PURE__ */ jsx77(FormDescription, { children: field.description }),
          /* @__PURE__ */ jsx77(FormMessage, {})
        ] })
      },
      field.name
    )),
    /* @__PURE__ */ jsx77(Button, { type: "submit", loading: isLoading, theme: "active", children: submitText })
  ] }) }) });
}

// src/organisms/MediaGrid/MediaGrid.tsx
import { useState as useState16 } from "react";
import { YStack as YStack57, XStack as XStack38, Text as Text42, Image, Button as Button9, ScrollView as ScrollView5, Stack as Stack2 } from "tamagui";
...
var MediaGrid = ({
  ...
  return /* @__PURE__ */ jsxs64(YStack57, { gap: "$4", f: 1, children: [
    /* @__PURE__ */ jsxs64(XStack38, { justifyContent: "space-between", alignItems: "center", children: [
      /* @__PURE__ */ jsxs64(XStack38, { gap: "$2", children: [
        onUpload && /* @__PURE__ */ jsx78(Button9, { icon: Upload2, onPress: onUpload, children: "Upload" }),
        selectedIds.length > 0 && onDelete && /* @__PURE__ */ jsxs64(
          Button9,
          {
            theme: "red",
            icon: Trash2,
      ...
      /* @__PURE__ */ jsxs64(XStack38, { gap: "$2", backgroundColor: "$background", padding: "$1", borderRadius: "$4", children: [
        /* @__PURE__ */ jsx78(
          Button9,
          {
            size: "$3",
    ...
    /* @__PURE__ */ jsx78(ScrollView5, { children: /* @__PURE__ */ jsxs64(XStack38, { flexWrap: "wrap", gap: "$4", children: [
      items.map((item) => /* @__PURE__ */ jsx78(
        MediaItemCard,
        {
          item,
      ...
      items.length === 0 && !isLoading && /* @__PURE__ */ jsx78(YStack57, { f: 1, alignItems: "center", justifyContent: "center", padding: "$10", children: /* @__PURE__ */ jsx78(Text42, { color: "$color10", children: "No media found" }) })
    ] }) })
  ] });
};
var MediaItemCard = ({
    ...
    return /* @__PURE__ */ jsxs64(
      XStack38,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs64(YStack57, { f: 1, children: [
            /* @__PURE__ */ jsx78(Text42, { fontWeight: "bold", children: item.title }),
          ...
          selected && /* @__PURE__ */ jsx78(Check7, { color: "$blue10" })
        ]
      }
    );
  }
      ...
      children: [
        ...
        selected && /* @__PURE__ */ jsx78(
          Stack2,
          {
            ...
            padding: 4,
            borderRadius: 100,
            children: /* @__PURE__ */ jsx78(Check7, { size: 12, color: "white" })
          }
        ),
        /* @__PURE__ */ jsx78(
          YStack57,
          {
            ...
            backgroundColor: "rgba(0,0,0,0.5)",
            padding: "$2",
            children: /* @__PURE__ */ jsx78(Text42, { color: "white", numberOfLines: 1, fontSize: "$2", children: item.title })
          }
        )
      ]
    }
...
import { YStack as YStack58, XStack as XStack39, Text as Text43, Button as Button10, Input as Input2, Separator as Separator8, Image as Image2, Spinner as Spinner5 } from "tamagui";
...
var AuthScreen = ({
  ...
  return /* @__PURE__ */ jsx79(YStack58, { f: 1, alignItems: "center", justifyContent: "center", padding: "$4", backgroundColor: "$background", children: /* @__PURE__ */ jsxs65(Card, { width: "100%", maxWidth: 400, padding: "$6", gap: "$4", elevation: "$2", children: [
    /* @__PURE__ */ jsxs65(YStack58, { alignItems: "center", gap: "$2", marginBottom: "$4", children: [
      typeof logo === "string" ? /* @__PURE__ */ jsx79(Image2, { source: { uri: logo }, width: 60, height: 60, borderRadius: "$2" }) : logo,
      /* @__PURE__ */ jsx79(Text43, { fontSize: "$6", fontWeight: "bold", children: title || (view === "login" ? "Welcome Back" : "Create Account") }),
      subtitle && /* @__PURE__ */ jsx79(Text43, { color: "$color10", textAlign: "center", children: subtitle })
    ] }),
    error2 && /* @__PURE__ */ jsx79(YStack58, { backgroundColor: "$red2", padding: "$2", borderRadius: "$2", children: /* @__PURE__ */ jsx79(Text43, { color: "$red10", children: error2 }) }),
    /* @__PURE__ */ jsxs65(YStack58, { gap: "$3", children: [
      view === "register" && /* @__PURE__ */ jsx79(
        Input2,
        {
          placeholder: "Name",
          value: name,
      ...
      view !== "forgot-password" && /* @__PURE__ */ jsx79(
        Input2,
        {
      ...
      view === "login" && onForgotPassword && /* @__PURE__ */ jsx79(
        Text43,
        {
          fontSize: "$2",
          color: "$blue10",
      ...
      /* @__PURE__ */ jsx79(
        Button10,
        {
          ...
          disabled: isLoading,
          icon: isLoading ? /* @__PURE__ */ jsx79(Spinner5, {}) : void 0,
          children: view === "login" ? "Sign In" : view === "register" ? "Sign Up" : "Reset Password"
        }
      )
    ] }),
    socialProviders && socialProviders.length > 0 && view === "login" && /* @__PURE__ */ jsxs65(YStack58, { gap: "$3", marginTop: "$2", children: [
      /* @__PURE__ */ jsxs65(XStack39, { alignItems: "center", gap: "$2", children: [
        /* @__PURE__ */ jsx79(Separator8, {}),
        /* @__PURE__ */ jsx79(Text43, { fontSize: "$2", color: "$color10", children: "Or continue with" }),
        /* @__PURE__ */ jsx79(Separator8, {})
      ] }),
      /* @__PURE__ */ jsx79(XStack39, { gap: "$2", justifyContent: "center", children: socialProviders.map((provider) => /* @__PURE__ */ jsx79(
        Button10,
        {
          icon: provider.icon,
    ...
    /* @__PURE__ */ jsx79(YStack58, { alignItems: "center", marginTop: "$4", children: view === "login" ? /* @__PURE__ */ jsxs65(Text43, { fontSize: "$2", color: "$color10", children: [
    ...
    ] }) : /* @__PURE__ */ jsxs65(Text43, { fontSize: "$2", color: "$color10", children: [
...
import { styled as styled63, Text as Text44, XStack as XStack40, YStack as YStack59 } from "tamagui";
import { jsx as jsx80, jsxs as jsxs66 } from "react/jsx-runtime";
var FieldFrame = styled63(YStack59, {
  name: "Field",
  gap: "$2"
});
var FieldLabel = Label;
var FieldControlFrame = styled63(YStack59, {
  name: "FieldControl",
  flex: 1
});
var FieldErrorFrame = styled63(Text44, {
  name: "FieldError",
  color: "$destructive",
  fontSize: "$2"
});
var FieldRoot = ({
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxs66(FieldFrame, { ...props, children: [
      /* @__PURE__ */ jsx80(Skeleton, { height: "$4", width: "$20" }),
      /* @__PURE__ */ jsx80(Skeleton, { height: "$10" })
    ] });
  }
  ...
  const finalChildren = childrenArray.map((child, index) => {
    ...
    if (child.type === FieldControlFrame) {
      const inputChild = React61.Children.only(child.props.children);
      const clonedInput = React61.cloneElement(
        inputChild,
        {
          state: hasError ? "error" : void 0,
          disabled: isDisabled2
      ...
      const finalControl = React61.cloneElement(
        child,
        { key: `field-child-${index}` },
        clonedInput
      );
      if (rightSlot) {
        return /* @__PURE__ */ jsxs66(XStack40, { gap: "$2", alignItems: "center", children: [
          finalControl,
          rightSlot
        ] }, `field-child-${index}`);
      }
  ...
  return /* @__PURE__ */ jsx80(FieldFrame, { ...props, children: finalChildren });
};
...
var InputGroup = ({
  ...
  return /* @__PURE__ */ jsxs67(InputGroupFrame, { hasError, disabled: isDisabled2, gap: "$2", children: [
    ...
    isLoading && /* @__PURE__ */ jsx81(Spinner6, {})
  ] });
};
...
import { YStack as YStack61 } from "tamagui";

// src/molecules/NativeSelect/NativeSelect.styles.ts
import { Label as TamaguiLabel2, styled as styled65, XStack as XStack42, YStack as YStack60 } from "tamagui";
var SelectContainer = styled65(YStack60, {
...
var NativeSelect = forwardRef13(
  ({ children, label, id: id2, hasError = false, isLoading = false, disabled = false, ...props }, ref) => {
    ...
    if (isLoading) {
      return /* @__PURE__ */ jsxs68(SelectContainer, { children: [
        label && /* @__PURE__ */ jsx82(Skeleton, { height: 20, width: 100 }),
        /* @__PURE__ */ jsx82(Skeleton, { height: 40 })
      ] });
    }
    return /* @__PURE__ */ jsxs68(SelectContainer, { children: [
      label && /* @__PURE__ */ jsx82(Label8, { htmlFor: selectId, hasError, children: label }),
      /* @__PURE__ */ jsxs68(SelectTrigger2, { hasError, disabled, children: [
        /* @__PURE__ */ jsx82(SelectElement, { id: selectId, ref, disabled, ...props, children }),
        /* @__PURE__ */ jsx82(YStack61, { pointerEvents: "none", position: "absolute", right: "$3", alignItems: "center", children: hasError ? /* @__PURE__ */ jsx82(AlertCircle8, { size: 16, color: "$red10" }) : /* @__PURE__ */ jsx82(ChevronDown6, { size: 16, color: "$color10" }) })
      ] })
    ] });
  }
);
...
var ResetPresence = (props) => {
  ...
  return /* @__PURE__ */ jsx83(PresenceContext.Provider, {
...
import React65, { createContext as createContext12, useContext as useContext16 } from "react";
...
function LocaleProvider(props) {
  ...
  return needsContext ? /* @__PURE__ */ React65.createElement(LocaleContext.Provider, {
    children,
    value: {
...
var createElement = (component, props, options) => {
  ...
  var element = /* @__PURE__ */ React66.createElement(Component3, domProps);
  var elementWithLocaleProvider = domProps.dir ? /* @__PURE__ */ React66.createElement(LocaleProvider, {
    children: element,
...
function RefreshControl(props) {
  ...
  return /* @__PURE__ */ React72.createElement(View_default, rest);
}
...
var ScrollView6 = class extends React74.Component {
  constructor() {
    super(...arguments);
  ...
  render() {
    ...
    var children = hasStickyHeaderIndices || pagingEnabled ? React74.Children.map(this.props.children, (child, i) => {
      var isSticky = hasStickyHeaderIndices && stickyHeaderIndices.indexOf(i) > -1;
      if (child != null && (isSticky || pagingEnabled)) {
        return /* @__PURE__ */ React74.createElement(View_default, {
    ...
    var contentContainer = /* @__PURE__ */ React74.createElement(View_default, (0, import_extends2.default)({}, contentSizeChangeProps, {
      children,
      collapsable: false,
    ...
    var scrollView = /* @__PURE__ */ React74.createElement(ScrollViewClass, (0, import_extends2.default)({}, props, {
      ref: this._setScrollNodeRef
    }), contentContainer);
    if (refreshControl) {
      return /* @__PURE__ */ React74.cloneElement(refreshControl, {
        style: props.style
      }, scrollView);
    }
    return scrollView;
...
var ForwardedScrollView = /* @__PURE__ */ React74.forwardRef((props, forwardedRef) => {
  return /* @__PURE__ */ React74.createElement(ScrollView6, (0, import_extends2.default)({}, props, {
    forwardedRef
  }));
});
...
import { useContext as useContext18, useMemo as useMemo15 } from "react";
...
function VirtualizedListCellContextProvider(_ref3) {
  ...
  var context = useMemo15(() => currContext == null ? null : (0, import_objectSpread29.default)((0, import_objectSpread29.default)({}, currContext), {}, {
    cellKey
  }), [currContext, cellKey]);
  return /* @__PURE__ */ React76.createElement(VirtualizedListContext.Provider, {
    value: context
...
// ../../node_modules/react-native-web/dist/vendor/react-native/Animated/useAnimatedProps.js
import { useCallback as useCallback8, useEffect as useEffect7, useMemo as useMemo16, useReducer, useRef as useRef10 } from "react";
function useAnimatedProps(props) {
  var _useReducer = useReducer((count) => count + 1, 0), scheduleUpdate = _useReducer[1];
  var onUpdateRef = useRef10(null);
  var node = useMemo16(() => new AnimatedProps_default(props, () => onUpdateRef.current == null ? void 0 : onUpdateRef.current()), [props]);
...
function useAnimatedNumber(initial) {
  const state = React91.useRef(null);
...
function createAnimations(animations2) {
  return {
    ...
    useAnimations: ({
      ...
      const isDisabled2 = isWeb && componentState.unmounted === true, isExiting = presence?.[0] === false, sendExitComplete = presence?.[1], animateStyles = React91.useRef({}), animatedTranforms = React91.useRef([]), animationsState = React91.useRef(/* @__PURE__ */ new WeakMap()), animateOnly = props.animateOnly || [], hasAnimateOnly = !!props.animateOnly, args = [JSON.stringify(style), componentState, isExiting, !!onDidAnimate], isThereNoNativeStyleKeys = React91.useMemo(() => isWeb ? true : Object.keys(style).some((key) => animateOnly ? !animatedStyleKey[key] && animateOnly.indexOf(key) === -1 : !animatedStyleKey[key]), args), res = React91.useMemo(() => {
...
var AppProviders = ({ theme = "light", children }) => /* @__PURE__ */ jsx84(TamaguiProvider, { config: tamagui_config_default, defaultTheme: theme, children: /* @__PURE__ */ jsx84(PortalProvider, { shouldAddRootHost: true, children: /* @__PURE__ */ jsx84(ErrorBoundary, { componentName: "AppProviders", children }) }) });
